...
const sandbox={
 ...
 navigator:{userAgent:"Chrome Test",clipboard:{writeText:async()=>{}}},
 document:{
  ...
  body:{appendChild(){},removeChild(){}},documentElement:{style:{}},execCommand(){return true}
 },
 alert(){},confirm(){return true},setTimeout,clearTimeout,FileReader:function(){},Blob:function(){},
...
if(!sandbox.CAPS||sandbox.CAPS.version!=="0.7.9")throw new Error("Version falsch");
