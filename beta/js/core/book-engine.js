...
function generate(input){
 ...
 const chars=(b.characters.length?b.characters:[{name:"Hauptfigur",role:"Hauptfigur",age:b.childAge,strengths:["neugierig"],challenge:"muss eine Herausforderung überwinden",development:"lernt, Hilfe anzunehmen",description:""}]).map(c=>({id:uid("CHAR"),...c,strengths:arr(c.strengths)}));
 ...
 const beats=[
 ["Die vertraute Welt",`${chars[0].name} und die wichtigsten Beziehungen werden vorgestellt.`,"Ein ungewöhnlicher Hinweis kündigt das Abenteuer an."],
